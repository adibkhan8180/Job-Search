    ...
    <div className='mb-[4rem] mt-[6rem]'>
      ...
      <div className='grid gap-[10rem] grid-cols-3 items-center'>
        ...
        <div className='singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]'>
          <div className='flex items-center gap-3'>
            <div className='imgDiv p-[4px] rounded-[0.8rem] bg-[#f7dle1] h-[40px] w-[40px] flex items-center justify-center'>
      ...
      <div>
        <h1 className='text-blueColor text-[30px] font-bold'>Read to Switch a career?</h1>
